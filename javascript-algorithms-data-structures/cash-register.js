const STATUS = { closed: 'CLOSED', insufficientFunds: 'INSUFFICIENT_FUNDS', open: 'OPEN'}
...
function getTotalCashRegisterChange(cid) {
  return cid.reduce((accumulator, currentValue) => accumulator + currentValue[1], 0).toFixed(2);
}
